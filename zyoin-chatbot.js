// ============================================================
// ZYOIN CHATBOT — FRONTEND v6
// github.com/marketingzyoin/zyoin-tracker
//
// WEBFLOW FOOTER CODE:
//   <script>
//     window.ZYOIN_CONFIG = {
//       chatbot: "YOUR_APPS_SCRIPT_URL_HERE",
...
(function () {
  ...
  // ── PAGE SCRAPER — auto-adapts when website is updated ────────
  ...
  function buildSystem() {
    return (
      'You are Zara, Zyoin Groups AI hiring assistant. Be warm, concise (2-4 sentences), helpful.\n\n' +
      'RULES:\n' +
  ...
  function getUTMs() {
    try {
      var stored = sessionStorage.getItem('zyoin_utms');
      ...
      if (utms.source || utms.medium || utms.campaign) {
        sessionStorage.setItem('zyoin_utms', JSON.stringify(utms));
      }
      return utms;
    } catch (e) { return {}; }
  }
  ...
  function lockInput(ph) {
    ...
    i.disabled = true;
    i.placeholder = ph || 'Please fill in your details above...';
  ...
  function unlockInput() {
    var i = document.getElementById('zara-in');
    i.disabled = false;
    i.placeholder = 'Ask me anything about hiring...';
  ...
  // ── HIRING → service buttons ──────────────────────────────────
  function onHiring() {
    addMsg('I am Hiring', 'u');
  ...
  function showLeadForm() {
    ...
    document.getElementById('zf-submit').onclick = function () {
      ...
      setTimeout(function () {
        ...
        formDone = true;
        unlockInput();
        var summary = 'Form submitted. Name: ' + name + ', Company: ' + company + ', Email: ' + email + ', Phone: ' + phone + ', Interested in: ' + userNeed + '.';
        busy = true;
        document.getElementById('zara-send').disabled = true;
        showTyping();
